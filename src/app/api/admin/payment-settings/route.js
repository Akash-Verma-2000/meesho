...
export async function POST(req) {
    ...
    try {
        ...
        const { qrCodeBase64 } = await req.json();

        if (!qrCodeBase64) {
            response.message = "QR Code Base64 string is required.";
        ...
        const update = { qrCodeBase64: qrCodeBase64 };
        ...
        console.error("Admin Payment Settings API error (POST):", error);
